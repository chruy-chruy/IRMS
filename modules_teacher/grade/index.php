    ...
    <div class="table_wrap"> 
        ...
        <table id="example" class="data list">
            ...
            <tbody>
                ...
                $query = mysqli_query($conn, "SELECT s.id, s.first_name, s.last_name, s.grade_level, s.lrn_number FROM student s INNER JOIN section_student ss ON s.id = ss.student INNER JOIN section_subject sub ON ss.section = sub.section WHERE sub.teacher = '$teacher_id' ORDER BY s.grade_level ASC");
