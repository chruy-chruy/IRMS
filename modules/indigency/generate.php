...
while ($row = mysqli_fetch_array($squery)) {
 ?>
        ...
        <form class="row g-3" action="certificate.php?id=<?php echo $row['id']?>" method="post">
        <br>
        <br>
            <div class="grid-container grid-container--fill">
                ...
                <div class="grid-item">
                    ...
                    <textarea required name="purpose" rows="500" cols="5" placeholder="Example: Financial Assistance for the hospitalization of his/her brother JIMBOY L. TIO who is presently admitted at DOCTORS HOSPITAL, General Santos City."></textarea>
                </div>
