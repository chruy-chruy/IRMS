...
<a href="./grade_level.php?grade=7&sy=<?php echo $sy?>" class="schedule">
    <div class="box-icon"><i class="fa fa-users"></i></div>
    Grade 7
</a>

<a href="./grade_level.php?grade=8&sy=<?php echo $sy?>" class="schedule">
  <div class="box-icon"><i class="fa fa-users"></i></div>
  Grade 8
</a>

<a href="./grade_level.php?grade=9&sy=<?php echo $sy?>" class="schedule">
  <div class="box-icon"><i class="fa fa-users"></i></div>
  Grade 9
</a>

<a href="./grade_level.php?grade=10&sy=<?php echo $sy?>" class="schedule">
  <div class="box-icon"><i class="fa fa-users"></i></div>
  Grade 10
</a>
